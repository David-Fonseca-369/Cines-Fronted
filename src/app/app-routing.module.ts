...
const routes: Routes = [
  ...
  //Wildcard debe ir al final, ya que debe atrapar todas la rutas
  //Puedes agregar 404 personalizado
  // {path: '**', component: LandingPageComponent} //esta es valida pero, deja la url erronea
