...
export class DetallePeliculaComponent implements OnInit {
  ...
  constructor(private peliculasService: PeliculasService,
    ...
    private sanitizer: DomSanitizer, //Se asegura de que no haya nada malicioso en la URL.
    private reatingService : RatingService
    ) { }

    pelicula: PeliculaDTO;
    fechaLanzamiento: Date;
    trailerURL: SafeResourceUrl; //Convertirla a una URL segura, angular nos mandaría mensajes de advertencia en caso de que 
    //no pasemos por este mecanismo de seguridad.
  ...
  rated(puntuacion: number){
    this.reatingService.rate(this.pelicula.id, puntuacion)
    .subscribe(() => {
