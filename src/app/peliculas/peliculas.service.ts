...
export class PeliculasService {
  ...
  public filtrar(valores: any): Observable<any>{ //retonara un conjunto de valores en un objeto
    const params = new HttpParams({fromObject: valores});

    return this.http.get<PeliculaCreacionDTO[]>(`${this.apiURL}/filtrar`,
