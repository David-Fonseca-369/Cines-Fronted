...
export class MapaComponent implements OnInit {
  ...
  ngOnInit(): void {
    //Recibo las coordenadas, para mostrarlas en el mapa
  ...
  options = {
    ...
    zoom: 14,
    center: latLng(19.714177101306795, -99.95344161987306)
  };
  ...
  manejarClick(event: LeafletMouseEvent){
    ...
    //EL componente padre que este utilizando, rebirá las coordenadas.
